...
export default function Homepage() {
  return (
    <div className="flex space-x-40  items-center justify-between min-h-screen py-2 w-full ">
      {/* Text component */}
      <div className="w-1/2 flex flex-col text-left space-y-8">
      ...
      {/* Image component */}
      <div className="w-1/2 ">
        <img src={image} alt="Homepage Image" className="w-3/4 h-auto" />
        <div>
          <Button className="relative bottom-20 left-20 bg-white flex space-x-2 text-center items-center">
          ...
          <Button className="relative bottom-40 left-60 bg-white flex space-x-2 text-center items-center">
            <div className="bg-green-700 p-1 rounded-full">
