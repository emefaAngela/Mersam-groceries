    ...
    <div className="w-full h-full m-0">
      ...
      <div className="flex sm:flex-row flex-col  sm:space-x-36  space-y-8   w-full sm:items-center sm:mx-auto mx-auto justify-center  mb-16">
        <div className="flex sm:w-1/3 w-full flex-col">
          <div className="text-2xl font-semibold mb-8">Delivery Details</div>
          <div>
            <form className="flex flex-col space-y-4">
              <div className="flex flex-col  sm:flex-row sm:space-x-4">
                ...
                <div className="flex flex-col space-y-2">
                  <div className="text-sm font-medium">Town</div>
                  <input
                    value={town}
              ...
              <div>
                <div className="text-sm font-medium">Landmark</div>
                <input
                  value={landmark}
              ...
              <div>
                ...
                <span className="text-sm ml-2">
                  Click to confirm using this delivery details for your order{" "}
